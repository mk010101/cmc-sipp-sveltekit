import { defineEl } from "../CmcElement.js";
...
export class CmcCheck extends CmcInputElement {
    ...
    <style>
      ...
      .cmc-check__input:focus ~ * {
        color: var(--color-accent-base, #0312df);;
      }
      ...
      cmc-check[shape="circle"] .cmc-check--checked, 
      cmc-check[shape="circle"] .cmc-check--unchecked {
