...
export class CmcButton extends CmcInputElement {
  ...
  <style>
    ...
    cmc-button[iconposition="right"] div[data-id="icon-holder"] {
      margin-right: 0;
      margin-left: .25rem;
    }
    ...
    cmc-button[iconsize=l][iconposition="right"] div[data-id="icon-holder"] {
      margin-right: 0;
      margin-left: .5rem;
    }
    ...
    cmc-button[iconsize=xl][iconposition="right"] div[data-id="icon-holder"] {
      margin-right: 0;
      margin-left: .5rem;
    }
